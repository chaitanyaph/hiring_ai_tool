...
/** No dedicated single-application internal endpoint exists (confirmed by research) -- only this job-scoped list. Enrichment filters client-side by applicationId when the triggering event carries both jobId and applicationId. */
