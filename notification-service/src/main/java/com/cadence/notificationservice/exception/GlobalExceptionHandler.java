...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleNotificationServiceException(NotificationServiceException ex, HttpServletRequest request) {
        log.warn("NotificationServiceException [{}]: {}", ex.getErrorCode(), ex.getMessage());
