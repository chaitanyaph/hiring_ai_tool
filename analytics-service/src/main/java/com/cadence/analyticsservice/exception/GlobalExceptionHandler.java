...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleAnalyticsServiceException(AnalyticsServiceException ex, HttpServletRequest request) {
        log.warn("AnalyticsServiceException [{}]: {}", ex.getErrorCode(), ex.getMessage());
