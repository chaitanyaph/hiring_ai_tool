...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleCandidateServiceException(CandidateServiceException ex, HttpServletRequest request) {
        log.warn("CandidateServiceException [{}]: {}", ex.getErrorCode(), ex.getMessage());
