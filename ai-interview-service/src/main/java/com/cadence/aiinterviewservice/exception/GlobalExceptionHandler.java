...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(AiInterviewServiceException.class)
    public ResponseEntity<ApiError> handleAiInterviewServiceException(AiInterviewServiceException ex, HttpServletRequest request) {
        log.warn("AiInterviewServiceException [{}]: {}", ex.getErrorCode(), ex.getMessage());
