...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleApplicationServiceException(ApplicationServiceException ex, HttpServletRequest request) {
        log.warn("ApplicationServiceException [{}]: {}", ex.getErrorCode(), ex.getMessage());
