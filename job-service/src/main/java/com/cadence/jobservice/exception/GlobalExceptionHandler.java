...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleJobServiceException(JobServiceException ex, HttpServletRequest request) {
        log.warn("JobServiceException [{}]: {}", ex.getErrorCode(), ex.getMessage());
