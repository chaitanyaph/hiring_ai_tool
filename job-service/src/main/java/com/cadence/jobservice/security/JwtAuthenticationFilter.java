 ...
 * SecurityContext with a CurrentUser principal, whose companyId is the
 * single source of truth for company scoping throughout this service.
 * Roles arrive from Auth Service either as "ROLE_X" or bare "X" --
 * normalized here so hasRole() checks work regardless of that prefix
 * convention drifting between services over time.
 */
@Component
