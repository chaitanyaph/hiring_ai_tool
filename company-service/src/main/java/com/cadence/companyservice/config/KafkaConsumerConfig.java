 ...
 * since this group consumes both UserCreatedEvent and
 * InvitationAcceptedEvent, produced by a different service (Auth) that
 * doesn't share this service's Java type headers.
 */
@Configuration
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, Object> consumerFactory() {
        ...
        config.put(JsonDeserializer.TRUSTED_PACKAGES, "com.cadence.companyservice.kafka.event");
