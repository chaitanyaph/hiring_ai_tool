...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(OfferManagementServiceException.class)
    public ResponseEntity<ApiError> handleOfferManagementServiceException(OfferManagementServiceException ex, HttpServletRequest request) {
        log.warn("OfferManagementServiceException [{}]: {}", ex.getErrorCode(), ex.getMessage());
