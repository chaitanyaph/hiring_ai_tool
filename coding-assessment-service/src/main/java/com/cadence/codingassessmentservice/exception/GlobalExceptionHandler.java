...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(CodingAssessmentServiceException.class)
    public ResponseEntity<ApiError> handleCodingAssessmentServiceException(CodingAssessmentServiceException ex, HttpServletRequest request) {
        log.warn("CodingAssessmentServiceException [{}]: {}", ex.getErrorCode(), ex.getMessage());
