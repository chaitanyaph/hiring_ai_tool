...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(ResumeParserServiceException.class)
    public ResponseEntity<ApiError> handleResumeParserServiceException(ResumeParserServiceException ex, HttpServletRequest request) {
        log.warn("ResumeParserServiceException [{}]: {}", ex.getErrorCode(), ex.getMessage());
