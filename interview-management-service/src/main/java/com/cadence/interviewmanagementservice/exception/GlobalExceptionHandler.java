...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(InterviewManagementServiceException.class)
    public ResponseEntity<ApiError> handleInterviewManagementServiceException(InterviewManagementServiceException ex, HttpServletRequest request) {
        log.warn("InterviewManagementServiceException [{}]: {}", ex.getErrorCode(), ex.getMessage());
